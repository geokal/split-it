...
namespace QuizManager.Migrations
{
    ...
    [Migration("20251210134425_Added_ResearchGroup_Ipodomes")]
    partial class Added_ResearchGroup_Ipodomes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizManager.Models.AnnouncementAsResearchGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte[]>("ResearchGroupAnnouncementAttachmentFile")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("ResearchGroupAnnouncementDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("ResearchGroupAnnouncementRNG")
                        .HasColumnType("bigint");

                    b.Property<string>("ResearchGroupAnnouncementRNG_HashedAsUniqueID")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ResearchGroupAnnouncementResearchGroupEmail")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ResearchGroupAnnouncementStatus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("ResearchGroupAnnouncementTimeToBeActive")
                        .HasColumnType("datetime2");

                    b.Property<string>("ResearchGroupAnnouncementTitle")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("ResearchGroupAnnouncementUploadDate")
                        .HasColumnType("datetime2");

                    b.HasKey("Id");

                    b.HasIndex("ResearchGroupAnnouncementRNG_HashedAsUniqueID")
                        .IsUnique()
                        .HasFilter("[ResearchGroupAnnouncementRNG_HashedAsUniqueID] IS NOT NULL");

                    b.HasIndex("ResearchGroupAnnouncementResearchGroupEmail");

                    b.ToTable("AnnouncementAsResearchGroup");
                });
            ...
            modelBuilder.Entity("QuizManager.Models.Company", b =>
                {
                    ...
                    b.Property<string>("RnD_ContactPersonEmail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RnD_ContactPersonFullName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RnD_HeadName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyInternship", b =>
                {
                    ...
                    b.Property<int>("OpenSlots_CompanyInternships")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyJobApplied", b =>
                {
                    ...
                    b.Property<bool>("CompanyJobApplied_CandidateCVDownloaded")
                        .HasColumnType("bit");

                    b.Property<bool>("CompanyJobApplied_CandidateInfoSeenFromModal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyThesis", b =>
                {
                    ...
                    b.Property<int>("OpenSlots_CompanyThesis")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizManager.Models.CompanyThesisApplied", b =>
                {
                    ...
                    b.Property<bool>("CompanyThesisApplied_CandidateCVDownloaded")
                        .HasColumnType("bit");

                    b.Property<bool>("CompanyThesisApplied_CandidateInfoSeenFromModal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("QuizManager.Models.InternshipApplied", b =>
                {
                    ...
                    b.Property<bool>("CompanyInternshipApplied_CandidateCVDownloaded")
                        .HasColumnType("bit");

                    b.Property<bool>("CompanyInternshipApplied_CandidateInfoSeenFromModal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("QuizManager.Models.ProfessorInternship", b =>
                {
                    ...
                    b.Property<int>("OpenSlots_ProfessorInternship")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizManager.Models.ProfessorInternshipApplied", b =>
                {
                    ...
                    b.Property<bool>("ProfessorInternshipApplied_CandidateCVDownloaded")
                        .HasColumnType("bit");

                    b.Property<bool>("ProfessorInternshipApplied_CandidateInfoSeenFromModal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("QuizManager.Models.ProfessorThesis", b =>
                {
                    ...
                    b.Property<int>("OpenSlots_ProfessorThesis")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizManager.Models.ProfessorThesisApplied", b =>
                {
                    ...
                    b.Property<bool>("ProfessorThesisApplied_CandidateCVDownloaded")
                        .HasColumnType("bit");

                    b.Property<bool>("ProfessorThesisApplied_CandidateInfoSeenFromModal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("QuizManager.Models.ResearchGroup_Ipodomes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte[]>("ResearchGroup_Ipodomes_Attachment")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("ResearchGroup_Ipodomes_Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<byte[]>("ResearchGroup_Ipodomes_Images")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("ResearchGroup_Ipodomes_Keywords")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ResearchGroup_Ipodomes_Title")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ResearchGroup_Ipodomes");
                });
            ...
            modelBuilder.Entity("QuizManager.Models.AnnouncementAsResearchGroup", b =>
                {
                    b.HasOne("QuizManager.Models.ResearchGroup", "ResearchGroup")
                        .WithMany()
                        .HasForeignKey("ResearchGroupAnnouncementResearchGroupEmail")
                        .HasPrincipalKey("ResearchGroupEmail")
                        .OnDelete(DeleteBehavior.Restrict);
